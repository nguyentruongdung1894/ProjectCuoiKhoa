<%-- 
Document   : featured-pro
Created on : Jul 6, 2018, 10:52:45 AM
Author     : ScorPius 31
--%>
                    ...
                    <div class="item">
                        <div class="col-item">
                            <div class="product-image-area"> 
                                ...
                                <form action="" method="post" class="variants" id="product-actions-830910" enctype="multipart/form-data">
                                    <div class="hover_fly">
                            ...
                            <div class="info">
                                ...
                                <!--info-inner-->
                                <form action="/cart/add" method="post" class="variants" id="product-actions-830910" enctype="multipart/form-data">
                                    <div class="actions">
                                        <input type="hidden" name="variantId" value="1273197" />

            ...
            <div class="slider-items-products">
                <div id="brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6"> 
                        ...
                        <!-- Item -->
                        <div class="item"> <a href=""><img src="../jsp/images/b-logo1.png" alt="polo-theme"></a> </div>
                        <!-- End Item --> 

                        <!-- Item -->
                        <div class="item"> <a href=""><img src="../jsp/images/b-logo2.png" alt="polo-theme"></a> </div>
                        <!-- End Item --> 

                        <!-- Item -->
                        <div class="item"> <a href=""><img src="../jsp/images/b-logo3.png" alt="polo-theme"></a> </div>
                        <!-- End Item --> 

                        <!-- Item -->
                        <div class="item"> <a href=""><img src="../jsp/images/b-logo4.png" alt="polo-theme"></a> </div>
                        <!-- End Item --> 

                        <!-- Item -->
                        <div class="item"> <a href=""><img src="../jsp/images/b-logo5.png" alt="polo-theme"></a> </div>
                        <!-- End Item --> 

                        <!-- Item -->
                        <div class="item"> <a href=""><img src="../jsp/images/b-logo6.png" alt="polo-theme"></a> </div>
                        <!-- End Item --> 
        ...
        <div class="row">
            <div class="col-md-3 col-sm-4">
                ...
                <div class="payment-accept">
                    <div>
                        <img src="../jsp/images/payment-1-min73e8.png" alt="payment">
                        <img src="../jsp/images/payment-2-min.png" alt="payment">
                        <img src="../jsp/images/payment-3-min.png" alt="payment">
                        <img src="../jsp/images/payment-4-min.png" alt="payment">
                    </div>
                </div>
            </div>

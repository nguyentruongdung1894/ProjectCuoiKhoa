<%-- 
    Document   : middle-slider
    Created on : Jul 6, 2018, 10:53:42 AM
    Author     : ScorPius 31
--%>
                ...
                <div class="slider-items-products">
                    ...
                    <div id="bag-seller-slider" class="product-flexslider hidden-buttons hidden_popup_cart">
                        <div class="slider-items slider-width-col3"> 
                            <c:forEach items="${listProductSell}" var="pro">
                                <div class="item">
                                    <div class="col-item">
                                        ...
                                        <div class="info">
                                            <div class="info-inner">
                                                <div class="item-title"> <h3><a title="${pro.productName}" href="/tinh-yeu-ngot-ngao">${pro.productName}</a></h3></div>
                                                <!--item-title-->
            ...
            <div class="shoes-product-slider small-pr-slider cat-section">
                <div class="slider-items-products">
                    ...
                    <div id="shoes-slider" class="product-flexslider hidden-buttons hidden_popup_cart">
                        <div class="slider-items slider-width-col3"> 
                            <c:forEach items="${listProductSale}" var="pro">
                                <div class="item">
                                    <div class="col-item">
                                        <div class="product-image-area"> 
                                            <a class="product-image" title="${pro.productName}" href=""> 
                                            ...
                                            <form action="" method="post" class="variants" id="product-actions-830918" enctype="multipart/form-data">
                                                <div class="hover_fly">
                                                    <a class="exclusive ajax_add_to_cart_button btn-cart add_to_cart" href="#" title="Cho vào giỏ hàng">
                                                        <div><i class="icon-shopping-cart"></i><span>Cho vào giỏ hàng</span></div>
                                                    </a>
